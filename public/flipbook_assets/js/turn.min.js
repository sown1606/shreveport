		...
		g = {
			...
			destroy: function () {
				...
				if ('prevented' != t('destroying', this)) {
					...
					for (
						f(document).unbind(r.move, b.eventHandlers.touchMove).unbind(r.up, b.eventHandlers.touchEnd);
						0 !== b.totalPages;
				...
				if ('number' == typeof a) {
					...
					for (a = 0; a < d.length; a++)
						d[a] &&
							...
							(this.trigger('zoomed', [d[a], d, b.pageZoom[d[a]], b.zoom]), (b.pageZoom[d[a]] = b.zoom));
					return this;
				}
				return b.zoom;
			},
			...
			range: function (a) {
				...
				1 <= d[0] && d[1] <= e.totalPages
					...
					: (c = b = 5);
        //Added pagesInDOM by Best 11/28/2020
        var pagesInDOM = 5;
        if(e.totalPages >= pagesInDOM) {
          pagesInDOM = e.totalPages;
          return [1, pagesInDOM];
        }
				...
				var c,
					...
					f = function (a) {
						var c = a + b,
							...
							i = f ? ' odd ' : ' even ';
						e.pageObjs[a] &&
							(e.pageObjs[c] = e.pageObjs[a].removeClass('p' + a + ' odd even').addClass('p' + c + i));
						e.pagePlace[a] &&
							e.pageWrap[a] &&
							((e.pagePlace[c] = c),
							...
							e.pages[a] &&
								(e.pages[c] = e.pages[a].flip('options', { page: c, next: h || f ? c + 1 : c - 1 })),
							b &&
								(delete e.pages[a],
				...
				if (b.pageObjs[a]) {
					...
					for (var d = 0; d < c.length; d++)
						c[d] &&
							...
							(this.trigger('zoomed', [c[d], c, b.pageZoom[c[d]], b.zoom]), (b.pageZoom[c[d]] = b.zoom));
					g._removeFromDOM.call(this);
			...
			_eventStart: function (a, b, c) {
				...
				a.isDefaultPrevented() ||
					...
					'single' == d.display &&
						c &&
						(('l' == c.charAt(1) && 'ltr' == d.direction) || ('r' == c.charAt(1) && 'rtl' == d.direction)
