...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan
        {{--        @if($dataType->slug === 'datas')--}}
        {{--            <a class="btn btn-warning" id="bulk_warning_btn" data-toggle="modal" data-target="#importDatas"><i--}}
        {{--                    class="voyager-down-circled"></i> <span>Import</span></a>--}}
        {{--            <div id="importDatas" class="modal" tabindex="-1" role="dialog">--}}
        ...
        {{--                                        <h5 class="modal-title">Import Datas</h5>--}}
        {{--                                    </div>--}}
                                                ...
                                                <a href="/view-player-dashboard-by-account-id/{{$data->CSHRV_Player_ID}}"
                                                   ...
                                                   style="min-width: 110px;">
                                                    <i class="{{ $action->getIcon() }}"></i> <span
                                                        class="hidden-xs hidden-sm">View On Web</span>
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
