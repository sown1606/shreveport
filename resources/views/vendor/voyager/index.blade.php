    ...
    <div class="page-content">
        ...
        <div class="analytics-container">
            ...
            @else
                ...
                {{--                                text-align: center;--}}
                {{--                            }--}}
                {{--                            #pointsBalanceNextLevel {--}}
                {{--                                float: left;--}}
                {{--                                font-size: 14px;--}}
                {{--                            }--}}
                {{--                            #pointsBalanceNextLevel span {--}}
                {{--                                float: left;--}}
                {{--                                font-size: 14px;--}}
                {{--                            }--}}
                {{--                            #pointsBalance {--}}
                ...
                {{--                                    </div>--}}
                {{--                                    <div class="flipbook">--}}
                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic.jpg') }}" data-odd="1"--}}
                {{--                                           data-lightbox="big" class="page"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic.jpg') }}')"></a>--}}

                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic_1.jpg') }}" data-even="2"--}}
                {{--                                           data-lightbox="big" class="single"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic_1.jpg') }}')"></a>--}}

                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic_2.jpg') }}" data-odd="3"--}}
                {{--                                           data-lightbox="big" class="single"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic_2.jpg') }}')"></a>--}}

                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic_3.jpg') }}" data-even="4"--}}
                {{--                                           data-lightbox="big" class="single"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic_3.jpg') }}')"></a>--}}

                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic_4.jpg') }}" data-odd="5"--}}
                {{--                                           data-lightbox="big" class="single"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic_4.jpg') }}')"></a>--}}

                {{--                                        <a href="{{asset('flipbook_assets/pages/GetGraphic_5H.jpg') }}" data-even="6"--}}
                {{--                                           data-lightbox="big" class="single"--}}
                {{--                                           style="background-image:url('{{ asset('flipbook_assets/pages/GetGraphic_5.jpg') }}')"></a>--}}
                ...
                {{--                                <div class="space"><img onclick="onPageClick(2)" class="thumb-img"--}}
                {{--                                                        src="{{asset('flipbook_assets/pages/GetGraphic_1.jpg') }}"--}}
                {{--                                                        alt="">--}}
                {{--                                    <img onclick="onPageClick(3)" class="thumb-img"--}}
                {{--                                         src="{{asset('flipbook_assets/pages/GetGraphic_2.jpg') }}" alt=""></div>--}}

                {{--                                <div class="space"><img onclick="onPageClick(4)" class="thumb-img"--}}
                {{--                                                        src="{{asset('flipbook_assets/pages/GetGraphic_3.jpg') }}"--}}
                {{--                                                        alt="">--}}
                {{--                                    <img onclick="onPageClick(5)" class="thumb-img"--}}
                {{--                                         src="{{asset('flipbook_assets/pages/GetGraphic_4.jpg') }}" alt=""></div>--}}

                {{--                                <div class="space"><img onclick="onPageClick(6)" class="thumb-img active"--}}
                {{--                                                        src="{{asset('flipbook_assets/pages/GetGraphic_5.jpg') }}"--}}
                {{--                                                        alt=""></div>--}}
                ...
                {{--                                <li onclick="onPageClick(1)" class="dot"><a type="button" style="color: #7F7F7F">1</a>--}}
                {{--                                </li>--}}
                {{--                                <li onclick="onPageClick(2)" class="dot"><a type="button" style="color: #7F7F7F">2</a>--}}
                {{--                                </li>--}}
                {{--                                <li onclick="onPageClick(3)" class="dot"><a type="button" style="color: #7F7F7F">3</a>--}}
                {{--                                </li>--}}
                {{--                                <li onclick="onPageClick(4)" class="dot"><a type="button" style="color: #7F7F7F">4</a>--}}
                {{--                                </li>--}}
                {{--                                <li onclick="onPageClick(5)" class="dot"><a type="button" style="color: #7F7F7F">5</a>--}}
                {{--                                </li>--}}
                {{--                                <li onclick="onPageClick(6)" class="dot"><a type="button" style="color: #7F7F7F">6</a>--}}
                {{--                                </li>--}}
                {{--                            </ul>--}}
                {{--                        </div>--}}
...
@section('javascript')
    ...
    {{--                        $(document.getElementsByClassName('thumb-img')[page - 1]).addClass('active');--}}
    ...
    {{--                    $('#img-magnifier-container').css("left", event.pageX - magnifier.width() / 2);--}}
    {{--                    $('#img-magnifier-container').css("top", event.pageY - magnifier.height() / 2);--}}
    {{--                    $('#img-magnifier-container').show();--}}
    {{--                    var hoveredImage = $(event.target).css("background-image");--}}
    {{--                    var bg = hoveredImage.replace('url(', '').replace(')', '').replace(/\"/gi, "");--}}
    ...
    {{--                    var imgXPercent = (event.pageX - $(event.target).offset().left) / targetPage.width();--}}
    {{--                    targetLeft -= zoomedImageWidth * imgXPercent;--}}
    {{--                    var imgYPercent = (event.pageY - $(event.target).offset().top) / targetPage.height();--}}
    {{--                    targetTop -= zoomedImageHeight * imgYPercent;--}}

    {{--                    $('#img-magnifier-container .glass').attr("src", bg);--}}
    {{--                    $('#img-magnifier-container .glass').css("top", "" + targetTop + "px");--}}
    {{--                    $('#img-magnifier-container .glass').css("left", "" + targetLeft + "px");--}}
    {{--                });--}}
